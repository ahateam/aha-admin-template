  ...
  <el-menu
        ...
        <el-submenu :index="value.id">
          ...
          <span v-else>
            <el-menu-item :index="res.id">
              <span slot="title" >{{$t('router.'+res.name)}} </span>
            </el-menu-item>
          </span>
        </el-submenu>
      </span>
    <span v-else >
      <el-menu-item  :index="value.id">
        <i :class="value.icon" ></i>
        <span slot="title" >{{$t('router.'+value.name)}} </span>
      </el-menu-item>
    </span>
  </el-menu>
